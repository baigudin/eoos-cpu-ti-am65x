 ...
 */
#ifndef CPU_REG_MCU_PLL_DOMAIN_HPP_
#define CPU_REG_MCU_PLL_DOMAIN_HPP_
    ...
    namespace cpu
    {
        namespace reg
        {
            ...
            public:
                ...
                /**
                 * Addresses from R5F view
                 */
                static const intptr ADDRESS_PLL0 = 0x40D00010;
                static const intptr ADDRESS_PLL1 = 0x40D01010;

                /**
                 * Unlock values of KICK registers.
                 */
                static const uint32 KICK0_UNLOCK = 0x68EF3490;
                static const uint32 KICK1_UNLOCK = 0xD172BC5A;
            ...
            public:
                ...
                bool unlock()
                {
                    ...
                    if( isLocked )
                    {
                        kick0.value = KICK0_UNLOCK;
                        kick1.value = KICK1_UNLOCK;
                    }
                    return isLocked;
                }
...
#endif // CPU_REG_MCU_PLL_DOMAIN_HPP_
